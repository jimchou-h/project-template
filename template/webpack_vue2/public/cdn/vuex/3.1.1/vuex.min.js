...
!(function (t, e) {
  ...
  function f(t, n, o) {
    ...
    ;(i.config.silent = !0),
      (t._vm = new i({ data: { $$state: n }, computed: a })),
      (i.config.silent = c),
      t.strict &&
        (function (t) {
          t._vm.$watch(
      ...
      o.forEachAction(function (e, n) {
        ...
        !(function (t, e, n, o) {
          ;(t._actions[e] || (t._actions[e] = [])).push(function (e, i) {
            ...
            return (
              ((r = s) && 'function' == typeof r.then) || (s = Promise.resolve(s)),
              t._devtoolHook
                ? s.catch(function (e) {
  ...
  function l(t, e, n) {
    var o
    return (
      null !== (o = t) && 'object' == typeof o && t.type && ((n = e), (e = t), (t = t.type)),
  ...
  ;(a.state.get = function () {
    ...
    (s.prototype.subscribeAction = function (t) {
      return c('function' == typeof t ? { before: t } : t, this._actionSubscribers)
    }),

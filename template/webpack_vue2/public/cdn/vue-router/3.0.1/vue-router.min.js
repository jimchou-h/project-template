...
!(function (t, e) {
  ...
  function E(t) {
    ...
    return function (r, n) {
      for (
        var o = '', i = r || {}, a = (n || {}).pretty ? k : encodeURIComponent, u = 0;
        u < t.length;
        u++
      ) {
        var c = t[u]
  ...
  function I(t, e, r, n) {
    ...
    var c = b(i.path || ''),
      ...
      h = i.hash || c.hash
    return (
      h && '#' !== h.charAt(0) && (h = '#' + h), { _normalized: !0, path: p, query: f, hash: h }
    )
  }
  function V(t, e) {
    for (var r in e) t[r] = e[r]
  ...
  function z(t, e) {
    ...
    function n(t, n) {
      ...
      if (
        ...
        return r({ _normalized: !0, name: s, query: f, hash: h, params: l }, void 0, n)
      if (p) {
        var d = F(p, t)
        return r(
          {
        ...
        try {
          t(r, a, function (t) {
            !1 === t || e(t)
              ...
              ? (u(), 'object' == typeof t && t.replace ? i.replace(t) : i.push(t))
              : n(t)
          })
        } catch (t) {
          u(t)
